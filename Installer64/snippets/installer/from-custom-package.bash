...
# example #  local package_name="${package_prefix}${INST64_X_APP_NAME_CAPS_X_VERSION}_${INST64_X_APP_NAME_CAPS_X_PLATFORM}${package_sufix}"
...
# example #  local package_url="${INST64_X_APP_NAME_CAPS_X_SOURCE}/v${INST64_X_APP_NAME_CAPS_X_VERSION}"
  ...
  local app_installer='X_APP_INSTALLER_X'
